        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="text" id="name" class="form-control" name="name"
                       value="${category.name}" placeholder="Enter here...">
            </div>
        </div>

        <div class="mt-4 row">
            <div class="col-md-12 text-center">
                <button type="submit" id="save" value="${category.id}" class="btn btn-outline-success pl-5 pr-5">
                    Сохранить
                </button>
            </div>
        </div>
...
<script src="../../../resources/js/category/category_edit.js" type="text/javascript"></script>
</body>
</html>
