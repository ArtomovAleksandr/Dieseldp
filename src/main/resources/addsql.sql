...
insert into userorder (id,createorder,done,fone,`name`) value(1,'2005-12-26 23:50:30',0,'050-456-89-89','vasa');
insert into userorder (id,createorder,done,fone,`name`) value(2,'2018-12-26 23:50:30',0,'050-999-88-88','Petja');
insert into qungoodsinorder (id,quantity,order_id,goods_id)value(1,5,1,2);
insert into qungoodsinorder (id,quantity,order_id,goods_id)value(2,2,1,3);
insert into qungoodsinorder (id,quantity,order_id,goods_id)value(3,4,2,4);
insert into qungoodsinorder (id,quantity,order_id,goods_id)value(4,1,2,1);
select * from userorder;

drop table userorder;
drop table userorder_qungoodsinorder;
drop table qungoodsinorder;